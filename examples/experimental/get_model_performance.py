...
if __name__ == "__main__":
    ...
    # Load configurations
    eval_config = load_config("examples/experimental/config/eval_config_examples_curriculum")
    model_config = load_config("examples/experimental/config/model_config_examples_curriculum")
    ...
    for model in model_config.models:
        ...
        save_dir = os.path.join(eval_config.res_path, os.path.dirname(model.name))
